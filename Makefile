...
define display_help_message
	...
	@echo "  $(COLOR_BLUE)start$(COLOR_RESET)                      - Bootstrap the environement (see configuration in 'configs/basic-conf.json')"
...
define start
	@echo "Starting relay chain and parachain nodes (press ctrl-c to exit) ..."
...
.PHONY: all help setup build build-polkadot-relaychain build-centrifuge-parachain clean
